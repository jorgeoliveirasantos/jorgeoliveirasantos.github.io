...
// main.js
import { Content } from 'https://kaatan.azurewebsites.net/lib/acacia/content.js';
import { Renderer, } from 'https://kaatan.azurewebsites.net/lib/acacia/renderer.js';
...
class AcaciaDesktopApp extends HTMLElement {
    ...
    connectedCallback() {
        ...
        acaciaCSS.setAttribute("href", "https://kaatan.azurewebsites.net/lib/acacia/acacia.css");
        head.appendChild(acaciaCSS);
        const favicon = document.createElement("link");
        favicon.setAttribute("rel", "shortcut icon");
        favicon.setAttribute("type", "image/x-icon");
        favicon.setAttribute("href", "/files/ret_branco.svg");
...
export const Modal = {
    ...
    Waiting: (title, msg, callback = null) => {
        return new Promise(resolve => {
            ...
            let img = document.createElement("img");
            img.setAttribute("src", "https://kaatan.azurewebsites.net/lib/acacia/loading.svg");
            anm.appendChild(img);
            box.appendChild(anm);
    ...
    Error: (title, msg, fatal, callback = null) => {
        return new Promise(resolve => {
            ...
            let img = document.createElement("img");
            img.setAttribute("src", "https://kaatan.azurewebsites.net/lib/acacia/erro.svg");
